                            ...
                            <div class="card-content">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <img id="image" class="img-rounded" src="<?php if($_SESSION['avatar']==null){echo "../assets/img/anime3.jpg";}else{echo $_SESSION['avatar'];} ?>">
...
<script>
    ...
    function suahocvien() {
        ...
        if(avatar_name != ""){
            $.get("modules/updatedatabase.php",{tkhv:tk,hoten:hoten,ngaysinh:ngaysinh,sdt:sodienthoai,gmail:gmail,gioitinh:gioitinh,avatar_name:avatar_name,avatar_tmp:avatar_tmp},function () {
                swal({
            ...
            $.get("modules/updatedatabase.php",{tkhv:tk,hoten:hoten,ngaysinh:ngaysinh,sdt:sodienthoai,gmail:gmail,gioitinh:gioitinh,avatar_name:"",avatar_tmp:""},function () {
                swal({
                    title: 'Sửa thành công!',
                    text: 'Đã sửa thông tin học viên',
                    type: 'success',
