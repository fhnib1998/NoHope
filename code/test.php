...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="../assetsKIT/img/apple-icon.png">
    <link rel="icon" href="../assetsKIT/img/favicon.png">
    <title>
...
<div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url('../assetsKIT/img/bg0.jpg');">
    <div class="container">
        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-shopping">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="img-container">
                                                <img src="../assetsKIT/img/product1.jpg" alt="...">
                                            </div>
                                        </td>
                                        <td class="td-name">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="img-container">
                                                <img src="../assetsKIT/img/product3.jpg" alt="...">
                                            </div>
                                        </td>
                                        <td class="td-name">
                    ...
                    <div class="row">
                        <div class="col-md-8 ml-auto mr-auto">
                            <div class="media-area">
                                ...
                                <div class="media">
                                    <a class="float-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object" src="../assetsKIT/img/faces/avatar.jpg" alt="...">
                                        </div>
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <div class="media media-post">
                                            <a class="author float-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object" alt="64x64" src="../assetsKIT/img/faces/kendall.jpg">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                ...
                                <div class="media">
                                    <a class="float-left" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object" alt="Tim Picture" src="../assetsKIT/img/faces/marc.jpg">
                                        </div>
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <a class="float-left" href="#pablo">
                                                <div class="avatar">
                                                    <img class="media-object" alt="64x64" src="../assetsKIT/img/faces/avatar.jpg">
                                                </div>
                                            </a>
                                            <div class="media-body">
                                                <h4 class="media-heading">Tina Andrew
                            ...
                            <div class="media media-post">
                                <a class="author float-left" href="#pablo">
                                    <div class="avatar">
                                        <img class="media-object" alt="64x64" src="../assetsKIT/img/placeholder.jpg">
                                    </div>
                                </a>
                                <div class="media-body">
                                    <form class="form">
        ...
        <div class="section-gray">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card card-blog">
                                <div class="card-header card-header-image">
                                    <a href="#pablo">
                                        <img class="img" src="../assetsKIT/img/examples/card-blog1.jpg">
            ...
            <div class="cards">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-background" style="background-image: url('../assetsKIT/img/examples/office1.jpg')">
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card card-background" style="background-image: url('../assetsKIT/img/examples/card-blog3.jpg')">
                                <div class="card-body">
            ...
            <div class="cards">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card card-pricing card-background" style="background-image: url('../assetsKIT/img/examples/card-blog3.jpg')">
                                <div class="card-body">
                ...
                <div class="container">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="rotating-card-container">
                                <div class="card card-rotate card-background">
                                    <div class="front front-background" style="background-image: url('../assetsKIT/img/examples/card-blog5.jpg');">
                                        <div class="card-body">
                                    ...
                                    <div class="back back-background" style="background-image: url('../assetsKIT/img/examples/card-blog5.jpg');">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                Manage Post
                                            </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="rotating-card-container manual-flip">
                                <div class="card card-rotate">
                                    <div class="front front-background" style="background-image: url('../assetsKIT/img/examples/card-blog6.jpg');">
                                        <div class="card-body">
                                            <h6 class="card-category">Full Background Card</h6>
                                            <a href="#pablo">
                                    ...
                                    <div class="back back-background" style="background-image: url('../assetsKIT/img/examples/card-blog6.jpg');">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                Manage Post
                                            </h5>
